...
<div class="row">
	...
	<form action="" method="POST" enctype="multipart/form-data">
		<div class="col-lg-9">
			...
			<textarea name="artikel" rows="20"><?php echo $this->input->post('judul') ?></textarea>
		</div>
		<div class="col-lg-3">
				...
				<div class="panel-body">
					<?php  
						...
						for($i=0; $i < count($status); $i++) {
							$checked = ($this->input->post('status')==$status[$i])?"checked":"";
				...
				<div class="panel-body">
					<?php  
						...
						foreach ($kategori as $kat) {
							$checked = ($this->input->post('id_kategori')==$kat->id_kategori)?"checked":"";
